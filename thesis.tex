...
\usepackage[toc]{appendix} % appendix in table of contents
\renewcommand{\appendixtocname}{\rmfamily Appendices}
...
\begin{appendices}
    \input{chapters/appendCh1}
    \input{chapters/appendCh2}
    \input{chapters/appendCh3}
    \input{chapters/appendCh4}
    \input{chapters/appendCh5}
    \input{chapters/appendCh6}
    \input{chapters/appendCh7}
    \input{chapters/appendCh8}
\end{appendices}


%% ----- 한글요약문 시작 (Korean summary) -----
\begin{summarykorean}
    \input{endmatter/summary.tex}
\end{summarykorean}
...
\pagestyle{empty} % 이후 쪽 번호없음
{
\linespread{1.7}\selectfont % narrow linespread in reference
\input{endmatter/acknowledge.tex}
}
