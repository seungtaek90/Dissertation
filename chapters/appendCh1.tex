...
Below are a useful set of physical constants and fundamental plasma parameters with all quantities in SI units except the temperature in $\text{eV}$ \cite{huba1998nrl, bellan2008fundamentals, tiesinga2021codata}.
